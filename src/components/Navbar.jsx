...
function Navbar() {
  ...
  return (
    <>
      <div
        className={` max-w-screen-2xl container mx-auto dark:bg-slate-800 dark:text-white md:px-20 px-4 fixed top-0 left-0 right-0 z-50 ${
          sticky
      ...
      >
        <div className="navbar">
          ...
          <div className="navbar-end space-x-3">
            ...
            <div className="">
              <a
                className="bg-black text-white px-3 py-2 rounded-md hover:bg-yellow-500 duration-300 cursor-pointer"
                onClick={() =>
